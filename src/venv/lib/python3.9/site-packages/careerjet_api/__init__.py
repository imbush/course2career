...
from careerjet_api.constants import Constants
...
class CareerjetAPIClient(object):
    ...
    def search(self, search_params):
        ...
        user_agent = 'careerjet-api-client-v' + pkg_resources.require("careerjet_api")[
            0].version + '-python-v' + platform.python_version()

        try:
            response = requests.get(Constants.API_URL + '/search',
                                    headers={'user-agent': user_agent, 'referer': referer_uri.geturl()},
